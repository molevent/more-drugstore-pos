...
🔹 รอชำระ
แสดงเฉพาะรายการที่ "อนุมัติแล้ว" แต่ยังไม่มีใบสำคัญจ่าย สามารถเลือกหลายรายการแล้วกด "ชำระรวม" เพื่อสร้างใบสำคัญจ่ายรวมได้ในครั้งเดียว

🔹 ดึงข้อมูล
เชื่อมต่อกับ Google Sheets เพื่อดึงข้อมูลค่าใช้จ่ายเข้ามา เหมาะสำหรับทีมที่กรอกข้อมูลผ่าน Google Sheets

� การ์ดสรุปด้านบน
- ยอดรวมค่าใช้จ่าย → จำนวนและยอดรวมทั้งหมด
- รอรับใบเสร็จ → รายการที่ยังไม่มีเลขที่ใบเสร็จ (receipt_number)
- รอทำใบสำคัญจ่าย → รายการ "ทุกสถานะ" ที่ยังไม่มีใบสำคัญจ่าย (รวมรอนุมัติ+อนุมัติแล้ว)
- รอชำระ (ในเมนูดรอปดาวน์) → นับเฉพาะ "อนุมัติแล้ว" ที่ยังไม่มีใบสำคัญจ่าย

⚠️ ทำไม "รอทำใบสำคัญจ่าย" กับ "รอชำระ" ไม่เท่ากัน?
เพราะ "รอทำใบสำคัญจ่าย" นับรวมรายการที่ยังรออนุมัติด้วย ส่วน "รอชำระ" นับเฉพาะที่อนุมัติแล้วพร้อมจ่ายเงิน

�🔹 ปุ่มลัดอื่นๆ
- ใบรับสินค้า → จัดการใบรับสินค้า
- ใบเสนอราคา → สร้างและจัดการใบเสนอราคา
- ใบสำคัญจ่าย → จัดการใบสำคัญจ่ายเงิน
- ภาษี → หัก ณ ที่จ่าย, ภ.พ.30, ใบกำกับภาษี
- เงินสดย่อย → จัดการเงินสดย่อย`
  },
  '/contacts': {
...
กดยืนยันเพื่อบันทึกเป็นค่าใช้จ่ายในระบบ พร้อมอัพเดทต้นทุนสินค้า`
  ...
  '/purchase-orders': {
    page_name_th: 'ใบรับสินค้า',
    page_name_en: 'Purchase Orders',
    short_description: 'สร้างและจัดการใบรับสินค้า',
    content: `🛍️ หน้าใบรับสินค้า

🔹 สร้างใบรับสินค้า
กดปุ่ม "สร้างใบรับสินค้า" เลือกผู้ขาย เพิ่มรายการสินค้า ระบุจำนวนและราคา
...
🔹 รับสินค้า
กดที่ใบรับสินค้า แล้วกด "รับสินค้า" ระบบจะเพิ่มสต็อกอัตโนมัติ`
  },
  '/payment-vouchers': {
