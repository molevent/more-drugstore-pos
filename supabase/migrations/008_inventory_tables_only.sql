-- ============================================================================
-- ระบบจัดการคลังสินค้า - สร้างตารางเท่านั้น (ไม่มี RLS Policies)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_stock_alerts_unresolved ON public.stock_alerts(is_resolved, alert_type);
